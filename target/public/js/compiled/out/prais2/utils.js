...
return clojure.string.replace.call(null,[cljs.core.str(value.toPrecision((3))),cljs.core.str("%")].join(''),/[.]0?0/,"");
} else {
return null;
}
});
...
return rum.core.with_key.call(null,b,a);
});

//# sourceMappingURL=utils.js.map?rel=1629049562791