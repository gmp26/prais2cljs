...
var args35112 = [];
var len__25738__auto___35116 = arguments.length;
var i__25739__auto___35117 = (0);
while(true){
if((i__25739__auto___35117 < len__25738__auto___35116)){
args35112.push((arguments[i__25739__auto___35117]));

var G__35118 = (i__25739__auto___35117 + (1));
i__25739__auto___35117 = G__35118;
continue;
} else {
}
break;
...
var G__35115 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__35115,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__35115;
}
});
...
var or__24663__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__25738__auto___35123 = arguments.length;
var i__25739__auto___35124 = (0);
while(true){
if((i__25739__auto___35124 < len__25738__auto___35123)){
args__25745__auto__.push((arguments[i__25739__auto___35124]));

var G__35125 = (i__25739__auto___35124 + (1));
i__25739__auto___35124 = G__35125;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__25746__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq35120){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__35121,G__35122,seq35120__$2);
});
...
var file = cljs.core.get.call(null,map__35129__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__35129__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__35129__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__35129,map__35129__$1,file,line,column){
return (function (p1__35126_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__35126_SHARP_));
});})(map__35129,map__35129__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__25588__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__25588__auto__,prefer_table__25589__auto__,method_cache__25590__auto__,cached_hierarchy__25591__auto__,hierarchy__25592__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__24663__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__24663__auto__)){
return or__24663__auto__;
} else {
...
var temp__4657__auto___35131 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___35131)){
var message_35132 = temp__4657__auto___35131;
cljs.core.println.call(null,message_35132);
} else {
}
...
var temp__4657__auto___35133 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___35133)){
var message_35134 = temp__4657__auto___35133;
cljs.core.println.call(null,message_35134);
} else {
}
...
var temp__4655__auto__ = (function (){var and__24651__auto__ = typeof exception.stack === 'string';
if(and__24651__auto__){
var G__35144 = exception.stack;
var G__35144__$1 = (((G__35144 == null))?null:clojure.string.split_lines.call(null,G__35144));
var G__35144__$2 = (((G__35144__$1 == null))?null:cljs.core.get.call(null,G__35144__$1,depth));
if((G__35144__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__35144__$2);
}
} else {
...
var vec__35145 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__35145,(0),null);
var column = cljs.core.nth.call(null,vec__35145,(1),null);
var vec__35148 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__35148,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__35148,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__35148,(2),null);
...
var m__$1 = (function (){var G__35152 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__35152) {
case "fail":
...
var G__35158 = (function (){var G__35157 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__35157);
} else {
return G__35157;
}
})();
...
return cljs.core.vary_meta.call(null,G__35160,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e35163){var e = e35163;
var G__35164 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__35164) {
...
var vec__35169 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__35169,(0),null);
var types = vec__35169;
...
return cljs.core.map.call(null,(function (p__35181){
var vec__35182 = p__35181;
var ns = cljs.core.nth.call(null,vec__35182,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__35182,(1),null);
return ((function (vec__35182,ns,vars__$1){
return (function (){
...
var G__35185 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__35185) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__35185,env,once_fixtures,each_fixtures,vec__35182,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__35185,env,once_fixtures,each_fixtures,vec__35182,ns,vars__$1){
return (function (){
var seq__35186 = cljs.core.seq.call(null,vars__$1);
var chunk__35187 = null;
var count__35188 = (0);
var i__35189 = (0);
while(true){
if((i__35189 < count__35188)){
var v = cljs.core._nth.call(null,chunk__35187,i__35189);
var temp__4657__auto___35191 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___35191)){
var t_35192 = temp__4657__auto___35191;
each_fixture_fn.call(null,((function (seq__35186,chunk__35187,count__35188,i__35189,t_35192,temp__4657__auto___35191,v,each_fixture_fn,G__35185,env,once_fixtures,each_fixtures,vec__35182,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_35192)));
});})(seq__35186,chunk__35187,count__35188,i__35189,t_35192,temp__4657__auto___35191,v,each_fixture_fn,G__35185,env,once_fixtures,each_fixtures,vec__35182,ns,vars__$1))
);
} else {
}

var G__35193 = seq__35186;
var G__35194 = chunk__35187;
var G__35195 = count__35188;
var G__35196 = (i__35189 + (1));
seq__35186 = G__35193;
chunk__35187 = G__35194;
count__35188 = G__35195;
i__35189 = G__35196;
continue;
} else {
var temp__4657__auto__ = cljs.core.seq.call(null,seq__35186);
if(temp__4657__auto__){
var seq__35186__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__35186__$1)){
var c__25474__auto__ = cljs.core.chunk_first.call(null,seq__35186__$1);
var G__35197 = cljs.core.chunk_rest.call(null,seq__35186__$1);
var G__35198 = c__25474__auto__;
var G__35199 = cljs.core.count.call(null,c__25474__auto__);
var G__35200 = (0);
seq__35186 = G__35197;
chunk__35187 = G__35198;
count__35188 = G__35199;
i__35189 = G__35200;
continue;
} else {
var v = cljs.core.first.call(null,seq__35186__$1);
var temp__4657__auto___35201__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___35201__$1)){
var t_35202 = temp__4657__auto___35201__$1;
each_fixture_fn.call(null,((function (seq__35186,chunk__35187,count__35188,i__35189,t_35202,temp__4657__auto___35201__$1,v,seq__35186__$1,temp__4657__auto__,each_fixture_fn,G__35185,env,once_fixtures,each_fixtures,vec__35182,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_35202)));
});})(seq__35186,chunk__35187,count__35188,i__35189,t_35202,temp__4657__auto___35201__$1,v,seq__35186__$1,temp__4657__auto__,each_fixture_fn,G__35185,env,once_fixtures,each_fixtures,vec__35182,ns,vars__$1))
);
} else {
}

var G__35203 = cljs.core.next.call(null,seq__35186__$1);
var G__35204 = null;
var G__35205 = (0);
var G__35206 = (0);
seq__35186 = G__35203;
chunk__35187 = G__35204;
count__35188 = G__35205;
i__35189 = G__35206;
continue;
}
} else {
...
});})(each_fixture_fn,G__35185,env,once_fixtures,each_fixtures,vec__35182,ns,vars__$1))
);
});})(each_fixture_fn,G__35185,env,once_fixtures,each_fixtures,vec__35182,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1629049577398