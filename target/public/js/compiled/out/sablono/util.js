...
var x__25326__auto__ = (((x == null))?null:x);
var m__25327__auto__ = (sablono.util.to_str[goog.typeOf(x__25326__auto__)]);
if(!((m__25327__auto__ == null))){
return m__25327__auto__.call(null,x);
} else {
var m__25327__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__25327__auto____$1 == null))){
return m__25327__auto____$1.call(null,x);
} else {
...
var x__25326__auto__ = (((x == null))?null:x);
var m__25327__auto__ = (sablono.util.to_uri[goog.typeOf(x__25326__auto__)]);
if(!((m__25327__auto__ == null))){
return m__25327__auto__.call(null,x);
} else {
var m__25327__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__25327__auto____$1 == null))){
return m__25327__auto____$1.call(null,x);
} else {
...
var len__25738__auto___26058 = arguments.length;
var i__25739__auto___26059 = (0);
while(true){
if((i__25739__auto___26059 < len__25738__auto___26058)){
args__25745__auto__.push((arguments[i__25739__auto___26059]));

var G__26060 = (i__25739__auto___26059 + (1));
i__25739__auto___26059 = G__26060;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__25746__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq26057){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq26057));
});
...
var vec__26064 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
...
var first_word = first__26066;
var words = seq__26065__$1;
...
var G__26068 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__26068,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys);
} else {
return G__26068;
}
} else {
...
var args__25745__auto__ = [];
var len__25738__auto___26071 = arguments.length;
var i__25739__auto___26072 = (0);
while(true){
if((i__25739__auto___26072 < len__25738__auto___26071)){
args__25745__auto__.push((arguments[i__25739__auto___26072]));

var G__26073 = (i__25739__auto___26072 + (1));
i__25739__auto___26072 = G__26073;
continue;
} else {
}
break;
...
var argseq__25746__auto__ = ((((0) < args__25745__auto__.length))?(new cljs.core.IndexedSeq(args__25745__auto__.slice((0)),(0),null)):null);
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__25746__auto__);
});

sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic = (function (maps){
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__26069_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__26069_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__26069_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__26069_SHARP_)){
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq26070){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq26070));
});
...
var vec__26079 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__26079,(0),null);
var names = cljs.core.nth.call(null,vec__26079,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__26079,tag_name,names){
return (function (p1__26074_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__26074_SHARP_));
});})(matches,vec__26079,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__26079,tag_name,names){
return (function (p1__26075_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__26075_SHARP_));
});})(matches,vec__26079,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__26082){
...
var tag = first__26091;
var content = seq__26090__$1;
...
var vec__26092 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__26092,(0),null);
var id = cljs.core.nth.call(null,vec__26092,(1),null);
var class$ = cljs.core.nth.call(null,vec__26092,(2),null);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__24663__auto__ = x__$1.hasDomain();
...
//# sourceMappingURL=util.js.map?rel=1629049554317