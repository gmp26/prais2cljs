...
var o9980 = temp__5733__auto__;
var temp__5733__auto____$1 = (o9980["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o9981 = temp__5733__auto____$1;
return (o9981["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__9089__auto__ = f;
return (o__9089__auto__["toString"]).call(o__9089__auto__);
} else {
return "";
}
}catch (e9982){var _ = e9982;
return "";
}});
...
try{var o__9089__auto___9984 = t;
(o__9089__auto___9984["cljs$lang$ctorPrWriter"]).call(o__9089__auto___9984,t,writer);
}catch (e9983){var __9985 = e9983;
}
...
var char_code = (function (){var o__9089__auto__ = (new String(char$));
return (o__9089__auto__["charCodeAt"]).call(o__9089__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__9089__auto__ = String;
return (o__9089__auto__["fromCharCode"]).call(o__9089__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__9986 = num_code;
switch (G__9986) {
case (1):
return (185);
...
var o__9089__auto__ = String;
return (o__9089__auto__["fromCharCode"]).call(o__9089__auto__,superscript_code);
});
/**
...
}catch (e9988){var _e__9096__auto__ = e9988;
return false;
}})())){
...
var vec__9989 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__9989,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o9992 = temp__5733__auto__;
var temp__5733__auto____$1 = (o9992["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o9993 = temp__5733__auto____$1;
return (o9993["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4736__auto___10000 = arguments.length;
var i__4737__auto___10001 = (0);
while(true){
if((i__4737__auto___10001 < len__4736__auto___10000)){
args__4742__auto__.push((arguments[i__4737__auto___10001]));

var G__10002 = (i__4737__auto___10001 + (1));
i__4737__auto___10001 = G__10002;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__9996){
var vec__9997 = p__9996;
var ns_detector = cljs.core.nth.call(null,vec__9997,(0),null);
...
var G__10003 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__10004 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__10003;
remaining_tokens = G__10004;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq9994){
var G__9995 = cljs.core.first.call(null,seq9994);
var seq9994__$1 = cljs.core.next.call(null,seq9994);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9995,seq9994__$1);
}));
...
var vec__10008 = cljs.core.split_with.call(null,(function (p1__10007_SHARP_){
return cljs.core.not_EQ_.call(null,p1__10007_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__10008,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__10008,(1),null);
...
var vec__10014 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__10014,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__10014,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__10017 = cljs.core.rest.call(null,remaining_tokens);
var G__10018 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__10017;
name_tokens = G__10018;
continue;
} else {
...
var vec__10021 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__10021,(0),null);
var arity = cljs.core.nth.call(null,vec__10021,(1),null);
var vec__10024 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__10024,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__10024,(1),null);
var vec__10027 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__10027,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__10027,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__10027,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__10027,(3),null);
...
var vec__10033 = result;
var munged_ns = cljs.core.nth.call(null,vec__10033,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__10033,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__10033,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__10033,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__10033,(4),null);
var arity = cljs.core.nth.call(null,vec__10033,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__10037 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__10037,(0),null);
var args = cljs.core.nth.call(null,vec__10037,(1),null);
var vec__10040 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__10040,(0),null);
var name = cljs.core.nth.call(null,vec__10040,(1),null);
...
var G__10043 = (arity + (1));
var G__10044 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__10045){
var vec__10046 = p__10045;
var arity = cljs.core.nth.call(null,vec__10046,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__10046,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__10049_SHARP_){
return cljs.core.get.call(null,arities,p1__10049_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__10050_SHARP_){
return cljs.core.drop.call(null,(2),p1__10050_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__10053){
var vec__10054 = p__10053;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__10054,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq10051){
var G__10052 = cljs.core.first.call(null,seq10051);
var seq10051__$1 = cljs.core.next.call(null,seq10051);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10052,seq10051__$1);
}));
...
var G__10060 = arg;
var G__10060__$1 = (((G__10060 instanceof cljs.core.Keyword))?G__10060.fqn:null);
switch (G__10060__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__10062__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__10062__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__10062__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__10062__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__10063 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__10063,(0),null);
var fn_name = cljs.core.nth.call(null,vec__10063,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__10063,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__10063,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__10063,(4),null);
var arity = cljs.core.nth.call(null,vec__10063,(5),null);
...
var o__9089__auto__ = f;
return (o__9089__auto__["getBasis"]).call(o__9089__auto__);
});
/**
...
}catch (e10067){var _e__9096__auto__ = e10067;
...
var G__10068 = (obj[cljs.core.first.call(null,path)]);
var G__10069 = cljs.core.rest.call(null,path);
obj = G__10068;
path = G__10069;
continue;
} else {
...
var _STAR_ = (function (accum,p__10070){
var vec__10071 = p__10070;
var bit = cljs.core.nth.call(null,vec__10071,(0),null);
var protocol = cljs.core.nth.call(null,vec__10071,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__10074){
var vec__10075 = p__10074;
var ns = cljs.core.nth.call(null,vec__10075,(0),null);
var name = cljs.core.nth.call(null,vec__10075,(1),null);
var selector = cljs.core.nth.call(null,vec__10075,(2),null);
...
var post_process = (function (p__10079){
var vec__10080 = p__10079;
var munged_name = cljs.core.nth.call(null,vec__10080,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__10080,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__10078_SHARP_){
return (obj[cljs.core.first.call(null,p1__10078_SHARP_)]);
}),sorted_matches);
