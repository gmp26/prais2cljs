...
var G__10085 = devtools.prefs.pref.call(null,v);
v = G__10085;
continue;
} else {
return v;
...
}catch (e10088){var _e__9096__auto__ = e10088;
return false;
}})();
...
}catch (e10092){var _e__9096__auto__ = e10092;
return false;
}})();
...
}catch (e10094){var _e__9096__auto__ = e10094;
return false;
}}
}
});
...
var vec__10096 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__10096,(0),null);
var name = cljs.core.nth.call(null,vec__10096,(1),null);
...
return cljs.core.some.call(null,(function (p1__10099_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__10099_SHARP_);
}),template);
});
