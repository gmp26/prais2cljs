...
try{return cljs.core.reduce.call(null,cljs.core._PLUS_,cljs.core.map.call(null,cljs.core._STAR_,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(100000000000),(10000),(1)], null),cljs.core.map.call(null,(function (p1__22306_SHARP_){
return parseInt(p1__22306_SHARP_);
...
var c_22309 = (new goog.debug.Console());
var G__22308_22310 = c_22309.getFormatter();
goog.object.set(G__22308_22310,"showAbsoluteTime",false);

goog.object.set(G__22308_22310,"showRelativeTime",false);


goog.object.set(goog.debug.Console,"instance",c_22309);
...
figwheel.repl.logging.log_levels = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,cljs.core.juxt.call(null,clojure.string.lower_case,(function (p1__22311_SHARP_){
return goog.object.get(goog.debug.Logger.Level,p1__22311_SHARP_);
...
return figwheel.repl.logging.warning.call(null,logger_SINGLEQUOTE_,["Log level ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,level))," doesn't exist must be one of ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,cljs.core.list("severe","warning","info","config","fine","finer","finest")))].join(''));
}
});
