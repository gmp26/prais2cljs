...
var reader = (function (){var or__3936__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__3936__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__3936__auto__)){
return or__3936__auto__;
} else {
return (128);
...
var map__25694 = top_item;
var map__25694__$1 = ((((!((map__25694 == null)))?(((((map__25694.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__25694.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__25694):map__25694);
var file = cljs.core.get.call(null,map__25694__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__25694__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__25694__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e25693){var _e = e25693;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5751__auto___25696 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5751__auto___25696)){
var seen_errors_25697 = temp__5751__auto___25696;
if(cljs.core.truth_(seen_errors_25697.has(self))){
} else {
seen_errors_25697.add(self);

var temp__5753__auto___25698 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5753__auto___25698)){
var sense_25699 = temp__5753__auto___25698;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_25699)].join('');
} else {
}
}
} else {
