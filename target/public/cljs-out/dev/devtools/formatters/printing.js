...
var len__4518__auto___23401 = arguments.length;
var i__4519__auto___23402 = (0);
while(true){
if((i__4519__auto___23402 < len__4518__auto___23401)){
args__4521__auto__.push((arguments[i__4519__auto___23402]));

var G__23403 = (i__4519__auto___23402 + (1));
i__4519__auto___23402 = G__23403;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq23398){
var G__23399 = cljs.core.first.call(null,seq23398);
var seq23398__$1 = cljs.core.next.call(null,seq23398);
var G__23400 = cljs.core.first.call(null,seq23398__$1);
var seq23398__$2 = cljs.core.next.call(null,seq23398__$1);
var self__4505__auto__ = this;
return self__4505__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23399,G__23400,seq23398__$2);
});
...
if(cljs.core.truth_((function (){var or__3936__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
return cljs.core._write.call(null,writer__4180__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__3925__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__3925__auto__){
var or__3936__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__3936__auto__)){
return or__3936__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__23404_SHARP_){
return !((cljs.core.meta.call(null,p1__23404_SHARP_) == null));
})))){
...
var map__23405 = opts;
var map__23405__$1 = ((((!((map__23405 == null)))?(((((map__23405.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__23405.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__23405):map__23405);
var markup_db = cljs.core.get.call(null,map__23405__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e23409){var _e__22389__auto__ = e23409;
return false;
}})();
if(cljs.core.truth_(or__3936__auto__)){
return or__3936__auto__;
...
}catch (e23411){var _e__22389__auto__ = e23411;
return false;
}}
})())){
...
var _STAR_current_state_STAR_23413 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__23414 = opts;
...
var markup_db = cljs.core.get.call(null,map__23414__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_23413;
}});
...
;
var temp__5751__auto___23418 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5751__auto___23418)){
var managed_print_level_23419 = temp__5751__auto___23418;
var _STAR_print_level_STAR_23417_23420 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_23419;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_23417_23420,managed_print_level_23419,temp__5751__auto___23418,writer,opts,job_fn){
return (function (p1__23416_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__23416_SHARP_,null);
});})(_STAR_print_level_STAR_23417_23420,managed_print_level_23419,temp__5751__auto___23418,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_23417_23420;
}} else {
job_fn.call(null);
}
