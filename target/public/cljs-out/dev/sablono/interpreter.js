...
var this$ = this;
var props = ({});
goog.object.extend(props,this$.props,({"value": (function (){var or__3936__auto__ = (this$.state["value"]);
...
var len__4518__auto___15275 = arguments.length;
var i__4519__auto___15276 = (0);
while(true){
if((i__4519__auto___15276 < len__4518__auto___15275)){
args__4521__auto__.push((arguments[i__4519__auto___15276]));

var G__15277 = (i__4519__auto___15276 + (1));
i__4519__auto___15276 = G__15277;
continue;
} else {
}
break;
...
/** @this {Function} */
sablono.interpreter.create_element.cljs$lang$applyTo = (function (seq15272){
...
return self__4505__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15273,G__15274,seq15272__$2);
});
...
var vec__15278 = sablono.normalize.element.call(null,element);
var type = cljs.core.nth.call(null,vec__15278,(0),null);
var attrs = cljs.core.nth.call(null,vec__15278,(1),null);
var content = cljs.core.nth.call(null,vec__15278,(2),null);
