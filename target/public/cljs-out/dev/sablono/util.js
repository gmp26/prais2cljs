...
return m__4231__auto__.call(null,x);
} else {
var m__4231__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__4231__auto____$1 == null))){
return m__4231__auto____$1.call(null,x);
} else {
...
var len__4518__auto___15241 = arguments.length;
var i__4519__auto___15242 = (0);
while(true){
if((i__4519__auto___15242 < len__4518__auto___15241)){
args__4521__auto__.push((arguments[i__4519__auto___15242]));

var G__15243 = (i__4519__auto___15242 + (1));
i__4519__auto___15242 = G__15243;
continue;
} else {
}
break;
...
/** @this {Function} */
sablono.util.as_str.cljs$lang$applyTo = (function (seq15240){
var self__4506__auto__ = this;
return self__4506__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq15240));
});
...
var vec__15244 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var seq__15245 = cljs.core.seq.call(null,vec__15244);
var first__15246 = cljs.core.first.call(null,seq__15245);
var seq__15245__$1 = cljs.core.next.call(null,seq__15245);
var first_word = first__15246;
var words = seq__15245__$1;
...
var G__15247 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__15247,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono.util.camel_case_keys);
} else {
return G__15247;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__15248_SHARP_){
if(typeof p1__15248_SHARP_ === 'string'){
return p1__15248_SHARP_;
} else {
return cljs.core.seq.call(null,p1__15248_SHARP_);
