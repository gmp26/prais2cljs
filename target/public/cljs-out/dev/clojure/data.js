...
return cljs.core.reduce.call(null,(function (result,p__24553){
...
var vec__24557 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__24557,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__24557,(1),null);
var ab = cljs.core.nth.call(null,vec__24557,(2),null);
...
if(!((m__4231__auto__ == null))){
return m__4231__auto__.call(null,a,b);
} else {
var m__4231__auto____$1 = (clojure.data.diff_similar["_"]);
if(!((m__4231__auto____$1 == null))){
return m__4231__auto____$1.call(null,a,b);
} else {
...
return (function (){var G__24566 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24566__$1)].join('')));
