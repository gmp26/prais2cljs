...
var G__14965 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__14965;
continue;
} else {
return ch;
...
var vec__14966 = cljs.core.re_find.call(null,pattern,s);
var match = cljs.core.nth.call(null,vec__14966,(0),null);
return (match === s);
});
...
var len__4518__auto___14971 = arguments.length;
var i__4519__auto___14972 = (0);
while(true){
if((i__4519__auto___14972 < len__4518__auto___14971)){
args__4521__auto__.push((arguments[i__4519__auto___14972]));

var G__14973 = (i__4519__auto___14972 + (1));
i__4519__auto___14972 = G__14973;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq14969){
var G__14970 = cljs.core.first.call(null,seq14969);
var seq14969__$1 = cljs.core.next.call(null,seq14969);
var self__4505__auto__ = this;
return self__4505__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14970,seq14969__$1);
});

cljs.tools.reader.impl.commons.throwing_reader = (function cljs$tools$reader$impl$commons$throwing_reader(msg){
return (function() { 
var G__14974__delegate = function (rdr,_){
return cljs.tools.reader.impl.errors.reader_error.call(null,rdr,msg);
};
var G__14974 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__14975__i = 0, G__14975__a = new Array(arguments.length -  1);
while (G__14975__i < G__14975__a.length) {G__14975__a[G__14975__i] = arguments[G__14975__i + 1]; ++G__14975__i;}
  _ = new cljs.core.IndexedSeq(G__14975__a,0,null);
} 
return G__14974__delegate.call(this,rdr,_);};
G__14974.cljs$lang$maxFixedArity = 1;
G__14974.cljs$lang$applyTo = (function (arglist__14976){
var rdr = cljs.core.first(arglist__14976);
var _ = cljs.core.rest(arglist__14976);
return G__14974__delegate(rdr,_);
});
