...
var i_16447 = (0);
while(true){
if((i_16447 < arr.length)){
(arr[i_16447] = null);

var G__16448 = (i_16447 + (1));
i_16447 = G__16448;
continue;
} else {
}
...
var i_16457 = (self__.level + (1));
while(true){
if((i_16457 <= (new_level + (1)))){
(update[i_16457] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_16459 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_16459[i]));
} else {
x__$2.forward.push((((i < links_16459.length))?(links_16459[i]):null));
}

if((i < links_16459.length)){
(links_16459[i] = x__$2);
} else {
links_16459.push(x__$2);
}
...
var i_16461 = (0);
while(true){
if((i_16461 <= self__.level)){
var links_16462 = (update[i_16461]).forward;
if((x__$1 === (((i_16461 < links_16462.length))?(links_16462[i_16461]):null))){
(links_16462[i_16461] = (x__$1.forward[i_16461]));

var G__16463 = (i_16461 + (1));
i_16461 = G__16463;
continue;
} else {
var G__16464 = (i_16461 + (1));
i_16461 = G__16464;
continue;
}
} else {
...
var G__16466 = nx;
var G__16467 = (level__$1 - (1));
x = G__16466;
level__$1 = G__16467;
continue;
} else {
var G__16468 = x;
var G__16469 = (level__$1 - (1));
x = G__16468;
level__$1 = G__16469;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__16471 = nx;
var G__16472 = (level__$1 - (1));
x = G__16471;
level__$1 = G__16472;
continue;
} else {
var G__16473 = x;
var G__16474 = (level__$1 - (1));
x = G__16473;
level__$1 = G__16474;
continue;
}
