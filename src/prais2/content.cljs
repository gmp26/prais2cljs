...
(def baseline
  [(Row. "Hospital A"	"A"	204	4	200	98.0	95.1	96.6	100.0	100.0)
   (Row. "Hospital B"	"B"	482	11	471	97.7	94.8	95.9	98.8	99.4)
   (Row. "Hospital C"	"C"	582	14	568	97.6	95.4	96.2	98.8	99.3)
   (Row. "Hospital D"	"D"	678	18	660	97.3	95.1	96.0	98.4	99.0)
   (Row. "Hospital E"	"E"	787	28	759	96.4	95.7	96.3	98.5	99.0)
   (Row. "Hospital F"	"F"	835	22	813	97.4	96.0	96.8	98.7	99.2)
   (Row. "Hospital G"	"G"	890	22	868	97.5	95.5	96.2	98.3	98.8)
   (Row. "Hospital H"	"H"	976	24	952	97.5	96.5	97.1	98.9	99.2)
   (Row. "Hospital I"	"I"	1056	26	1030	97.5	96.3	96.9	98.7	99.1)
   (Row. "Hospital J"	"J"	1107	17	1090	98.5	96.5	97.0	98.7	99.1)
   (Row. "Hospital K"	"K"	1146	31	1115	97.3	95.8	96.4	98.3	98.7)
   (Row. "Hospital L"	"L"	1204	41	1163	96.6	95.6	96.3	98.1	98.6)
   (Row. "Hospital M"	"M"	1481	36	1445	97.6	95.3	95.9	97.7	98.1)
   (Row. "Hospital N"	"N"	1881	38	1843	98.0	96.5	97.0	98.4	98.7)])

(def variation-1
  [(Row. "Hospital A"	"A"     204	4	200	98.04	95.10	96.57	100.00	100.00)
   (Row. "Hospital B"	"B"	482	11	471	97.72	94.81	95.85	98.76	99.38)
   (Row. "Hospital C"	"C"	582	14	568	97.59	95.36	96.22	98.80	99.31)
   (Row. "Hospital D"	"D"	678	18	660	97.35	95.13	96.02	98.38	98.97)
   (Row. "Hospital E"	"E"	787	35	752	95.55	95.68	96.32	98.48	98.98)
   (Row. "Hospital F"	"F"	835	22	813	97.37	96.05	96.77	98.68	99.16)
   (Row. "Hospital G"	"G"	890	22	868	97.53	95.51	96.18	98.31	98.76)
   (Row. "Hospital H"	"H"	976	24	952	97.54	96.52	97.13	98.87	99.18)
   (Row. "Hospital I"	"I"	1056	26	1030	97.54	96.31	96.88	98.67	99.05)
   (Row. "Hospital J"	"J"	1107	17	1090	98.46	96.48	97.02	98.74	99.10)
   (Row. "Hospital K"	"K"	1146	31	1115	97.29	95.81	96.42	98.25	98.69)
   (Row. "Hospital L"	"L"	1204	41	1163	96.59	95.60	96.26	98.09	98.59)
   (Row. "Hospital M"	"M"	1481	36	1445	97.57	95.34	95.88	97.70	98.11)
   (Row. "Hospital N"	"N"	1881	38	1843	97.98	96.54	97.02	98.35	98.67)])

(def variation-2a
  [(Row. "Hospital A"	"A"     204	3	201	98.5	95.1	96.6	100.0	100.0)
   (Row. "Hospital B"	"B"	482	11	471	97.7	94.8	95.9	98.8	99.4)
   (Row. "Hospital C"	"C"	582	14	568	97.6	95.4	96.2	98.8	99.3)
   (Row. "Hospital D"	"D"	678	18	660	97.3	95.1	96.0	98.4	99.0)
   (Row. "Hospital E"	"E"	787	28	759	96.4	95.7	96.3	98.5	99.0)
   (Row. "Hospital F"	"F"	835	17	818	98.0	96.0	96.8	98.7	99.2)
   (Row. "Hospital G"	"G"	890	22	868	97.5	95.5	96.2	98.3	98.8)
   (Row. "Hospital H"	"H"	976	19	957	98.1	96.5	97.1	98.9	99.2)
   (Row. "Hospital I"	"I"	1056	20	1036	98.1	96.3	96.9	98.7	99.1)
   (Row. "Hospital J"	"J"	1107	17	1090	98.5	96.5	97.0	98.7	99.1)
   (Row. "Hospital K"	"K"	1146	24	1122	97.9	95.8	96.4	98.3	98.7)
   (Row. "Hospital L"	"L"	1204	34	1170	97.2	95.6	96.3	98.1	98.6)
   (Row. "Hospital M"	"M"	1481	36	1445	97.6	95.3	95.9	97.7	98.1)
   (Row. "Hospital N"	"N"	1881	38	1843	98.0	96.5	97.0	98.4	98.7)])

(def variation-2b
  [(Row. "Hospital A"	"A"     204     3       201     98.5   95.1   96.6   100.0  100.0)
   (Row. "Hospital B"	"B"	482     8       474     98.3   94.8   95.9   98.8   99.4)
   (Row. "Hospital C"	"C"	582     11      571     98.1   95.4   96.2   98.8   99.3)
   (Row. "Hospital D"	"D"	678     15      663     97.8   95.1   96.0   98.4   99.0)
   (Row. "Hospital E"	"E"	787     28      759     96.4   95.7   96.3   98.5   99.0)
   (Row. "Hospital F"	"F"	835     17      818     98.0   96.0   96.8   98.7   99.2)
   (Row. "Hospital G"	"G"	890     17      873     98.1   95.5   96.2   98.3   98.8)
   (Row. "Hospital H"	"H"	976     19      957     98.1   96.5   97.1   98.9   99.2)
   (Row. "Hospital I"	"I"	1056    20      1036    98.1   96.3   96.9   98.7   99.1)
   (Row. "Hospital J"	"J"	1107    10      1097    99.1   96.5   97.0   98.7   99.1)
   (Row. "Hospital K"	"K"	1146    24      1122    97.9   95.8   96.4   98.3   98.7)
   (Row. "Hospital L"	"L"	1204    34      1170    97.2   95.6   96.3   98.1   98.6)
   (Row. "Hospital M"	"M"	1481    27      1454    98.2   95.3   95.9   97.7   98.1)
   (Row. "Hospital N"	"N"	1881    27      1854    98.6   96.5   97.0   98.4   98.7)])
...
(def variation-3
  [(Row. "Hospital A"	"A"     204	4	200	98.0	95.1	96.6	100.0	100.0)
   ...
   (Row. "Hospital H"	"H"	976	24	952	97.5	96.5	97.1	98.9	99.2)
   (Row. "Hospital I"	"I"	1056	26	1030	97.5	96.3	96.9	98.7	99.1)
   (Row. "Hospital J"	"J"	1107	11	1096	99.0	96.5	97.0	98.7	99.1)
   (Row. "Hospital K"	"K"	1146	31	1115	97.3	95.8	96.4	98.3	98.7)
   (Row. "Hospital L"	"L"	1204	41	1163	96.6	95.6	96.3	98.1	98.6)
   (Row. "Hospital M"	"M"	1481	36	1445	97.6	95.3	95.9	97.7	98.1)
   (Row. "Hospital N"	"N"	1881	38	1843	98.0	96.5	97.0	98.4	98.7)])
...
(def variation-4
  [(Row. "Hospital A"	"A"     204	4	200	98.0	95.1	96.6	100.0	100.0)
   ...
   (Row. "Hospital C"	"C"	582	14	568	97.6	95.4	96.2	98.8	99.3)
   (Row. "Hospital D"	"D"	678	18	660	97.3	95.1	96.0	98.4	99.0)
   (Row. "Hospital E"	"E"	787	35	752	95.6	95.7	96.3	98.5	99.0)
   (Row. "Hospital F"	"F"	835	22	813	97.4	96.0	96.8	98.7	99.2)
   (Row. "Hospital G"	"G"	890	22	868	97.5	95.5	96.2	98.3	98.8)
   (Row. "Hospital H"	"H"	976	24	952	97.5	96.5	97.1	98.9	99.2)
   (Row. "Hospital I"	"I"	1056	26	1030	97.5	96.3	96.9	98.7	99.1)
   (Row. "Hospital J"	"J"	1107	13	1094	98.8	96.5	97.0	98.7	99.1)
   (Row. "Hospital K"	"K"	1146	31	1115	97.3	95.8	96.4	98.3	98.7)
   (Row. "Hospital L"	"L"	1204	47	1157	96.1	95.6	96.3	98.1	98.6)
   (Row. "Hospital M"	"M"	1481	27	1454	98.2	95.3	95.9	97.7	98.1)
   (Row. "Hospital N"	"N"	1881	38	1843	98.0	96.5	97.0	98.4	98.7)])

(def variation-5
  [(Row. "Hospital A"	"A"     200	6	194	97.0	95.0	96.5	100.0	100.0)
   (Row. "Hospital B"	"B"	482	11	471	97.7	94.8	95.9	98.8	99.4)
   (Row. "Hospital C"	"C"	582	14	568	97.6	95.4	96.2	98.8	99.3)
   (Row. "Hospital D"	"D"	678	18	660	97.3	95.1	96.0	98.4	99.0)
   (Row. "Hospital E"	"E"	787	28	759	96.4	95.7	96.3	98.5	99.0)
   ...
   (Row. "Hospital L"	"L"	1204	41	1163	96.6	95.6	96.3	98.1	98.6)
   (Row. "Hospital M"	"M"	1481	36	1445	97.6	95.3	95.9	97.7	98.1)
   (Row. "Hospital N"	"N"	1881	67	1814	96.4	96.5	97.0	98.4	98.7)])
