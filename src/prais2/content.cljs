...
(def table1-data
  [(Row. (Header. "Hospital"              :asc       true)
         (Header. "Hospital Code"         :asc       true)
         (Header. "Number of Operations"  nil        true)
         (Header. "Number of Deaths"      nil        true)
         (Header. "Number of Survivors"   nil        true)
         (Header. "Survival Rate (%)"     nil        true)
         (Header. "Low Prediction (%)"    nil        false)
         (Header. "High Prediction (%)"   nil        false))
...
#_(defrecord Table1 [headers rows])

#_(def table1-data (Table1. [(Header. "Hospital"              :asc       :show)
