...
(rum/defc section-4-content []
  [:section.row
   [:p.col-lg-12 "The main measure that the NHS uses to monitor children’s heart surgery in the UK is the 30-day survival rate. This is the percentage of operations where the child survived at least 30 days after their heart surgery (e.g. 100% would mean that every child survived). Currently, about 3500 children under the age of 16 have heart surgery each year in the United Kingdom and Republic of Ireland."
    ]]
  )
