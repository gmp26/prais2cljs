   ...
   [:.row
    [:#faqs
     ...
     [:p
      ...
      "."]
     [:h2#q2.-what-does-the-national-audit-body-do
      "Q2. What does the national audit body do? "]
     [:p
      [:a
     ...
     [:h2#q3.-why-is-a-different-survival-range-predicted-for-each-hospital
      "Q3. Why is a different survival range predicted for each hospital? "]
     [:p
     ...
     [:h2#q4.-why-do-the-hospitals-that-do-more-operations-have-narrower-ranges
      "Q4. Why do the hospitals that do more operations have narrower ranges? "]
     [:p
     ...
     [:h2#q5.-what-does-it-mean-if-a-hospital-falls-outside-its-range
      "Q5. What does it mean if a hospital falls "
      [:em
       "outside"]
      " its range? "]
     [:p
     ...
     [:h2#q6.-which-hospital-should-i-go-to
     ...
     [:h2#q7.-can-the-published-data-tell-me-about-the-risks-for-my-child
      "Q7. Can the published data tell me about the risks for my child?"]
     [:p
     ...
     [:h2#q8.-how-reliable-are-the-data
      "Q8. How reliable are the data?"]
     [:p
     ...
     [:h2#q9.-what-are-the-limitations-of-the-data
      "Q9. What are the limitations of the data? "]
     [:p
     ...
     [:h2#q10-what-about-survival-after-30-days-and-quality-of-life
      "Q10 What about survival after 30 days? And quality of life? "]
     [:p
      "No. This data set only looks at what happens shortly after surgery. These data cannot tell us about longer term (e.g. 90 day, 1 year or 5 year) survival, or other outcomes such as post-surgery complication rates or the impact of surgery on the child or their family. There is a lot of "
      [:a
     ...
     [:h2#q11.-what-is-the-risk-adjustment-method-used-by-national-audit
     ...
     [:h2#q12.-are-there-any-limitations-to-risk-adjustment
